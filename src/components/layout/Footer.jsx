        ...
        <div className="footer__container">
          <div className="footer__content">
            <div className="footer__info">
              <a href="#" className="footer__logo">YourName</a>
            ...
            <div className="footer__nav">
              ...
              <div className="footer__nav-group">
                ...
                <ul className="footer__nav-list">
                  ...
                  <li><a href="#" className="footer__nav-link">GitHub</a></li>
                  <li><a href="#" className="footer__nav-link">Twitter</a></li>
                  <li><a href="mailto:your.email@example.com" className="footer__nav-link">Email</a></li>
                </ul>
              </div>
            </div>
          </div>
